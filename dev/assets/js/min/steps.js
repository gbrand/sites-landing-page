jQuery(document).ready(function($){
	...
	function createNavigation(steps, n) {
		var tourNavigationHtml = '<div class="cd-nav"><span><b class="cd-actual-step">1</b> de '+n+'</span><ul class="cd-tour-nav"><li><a href="#0" class="cd-prev">&#171; </a></li><li><a href="#0" class="cd-next"> &#187;</a></li></ul></div><a href="#0" class="cd-close">Close</a>';
